                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="fw-extrabold h5">Psikoedukasi</h2>
                                <h3 class="mb-1">{{ $psikoedukasi }}</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">Psikoedukasi</h2>
                                <h3 class="fw-extrabold mb-2">{{ $psikoedukasi }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="fw-extrabold h5">Latihan Relaksasi</h2>
                                <h3 class="mb-1">{{ $relaksasi }}</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">Latihan Relaksasi</h2>
                                <h3 class="fw-extrabold mb-2">{{ $relaksasi }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="fw-extrabold h5">Restrukturisasi Kognitif</h2>
                                <h3 class="mb-1">{{ $restrukturisasi }}</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">Restrukturisasi Kognitif</h2>
                                <h3 class="fw-extrabold mb-2">{{ $restrukturisasi }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div
                            ...
                            <div class="d-sm-none">
                                <h2 class="fw-extrabold h5">Terapi Perilaku</h2>
                                <h3 class="mb-1">{{ $terapi }}</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0">Terapi Perilaku</h2>
                                <h3 class="fw-extrabold mb-2">{{ $terapi }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
